package id.ijolan.auth.web.rest;

import id.ijolan.auth.IjolanauthApp;
import id.ijolan.auth.config.Constants;
import id.ijolan.auth.domain.Authority;
import id.ijolan.auth.domain.User;
import id.ijolan.auth.repository.AuthorityRepository;
import id.ijolan.auth.repository.UserRepository;
import id.ijolan.auth.security.AuthoritiesConstants;
import id.ijolan.auth.service.MailService;
import id.ijolan.auth.service.UserService;
import id.ijolan.auth.service.dto.PasswordChangeDTO;
import id.ijolan.auth.service.dto.UserDTO;
import id.ijolan.auth.web.rest.errors.ExceptionTranslator;
import id.ijolan.auth.web.rest.vm.KeyAndPasswordVM;
import id.ijolan.auth.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = IjolanauthApp.class)
