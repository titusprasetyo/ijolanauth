package id.ijolan.auth.repository;

import id.ijolan.auth.IjolanauthApp;
import id.ijolan.auth.config.Constants;
import id.ijolan.auth.config.audit.AuditEventConverter;
import id.ijolan.auth.domain.PersistentAuditEvent;
...
import static id.ijolan.auth.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
